...
<style>
    ...
    <div class="container mt-4">
        ...
        <br>
        <div class="container bg-white rounded shadow-sm p-4 pt-4 border">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-10 offset-sm-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="verified" name="field[0]" <?php echo $row['verified'] ? "checked" : "" ?>>
